...
static int
memb_pdcch_ConfigSIB1_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_pdcch_ConfigSIB1_constr_10 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_subCarrierSpacingCommon_3 = {
	...
	sizeof(asn_DEF_subCarrierSpacingCommon_tags_3)
		/sizeof(asn_DEF_subCarrierSpacingCommon_tags_3[0]), /* 1 */
...
asn_TYPE_descriptor_t asn_DEF_dmrs_TypeA_Position_7 = {
	...
	sizeof(asn_DEF_dmrs_TypeA_Position_tags_7)
		/sizeof(asn_DEF_dmrs_TypeA_Position_tags_7[0]), /* 1 */
...
asn_TYPE_descriptor_t asn_DEF_cellBarred_11 = {
	...
	sizeof(asn_DEF_cellBarred_tags_11)
		/sizeof(asn_DEF_cellBarred_tags_11[0]), /* 1 */
...
asn_TYPE_descriptor_t asn_DEF_intraFreqReselection_14 = {
	...
	sizeof(asn_DEF_intraFreqReselection_tags_14)
		/sizeof(asn_DEF_intraFreqReselection_tags_14[0]), /* 1 */
...
asn_TYPE_member_t asn_MBR_MIB_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MIB, pdcch_ConfigSIB1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_pdcch_ConfigSIB1_constr_10,  memb_pdcch_ConfigSIB1_constraint_1 },
		0, 0, /* No default value */
		"pdcch-ConfigSIB1"
		},
...
static const asn_TYPE_tag2member_t asn_MAP_MIB_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 2, 0, 1 }, /* ssb-SubcarrierOffset */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 4, -1, 0 }, /* pdcch-ConfigSIB1 */
    { (ASN_TAG_CLASS_UNIVERSAL | (3 << 2)), 0, 0, 0 }, /* systemFrameNumber */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 1, 0, 3 }, /* subCarrierSpacingCommon */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 3, -1, 2 }, /* dmrs-TypeA-Position */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 5, -2, 1 }, /* cellBarred */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 6, -3, 0 } /* intraFreqReselection */
};
